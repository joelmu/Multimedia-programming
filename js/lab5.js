$(document).ready(function() {
  ...
  $('#getAjax').click(function() {
    ...
    $.ajax({type: "GET", dataType: 'jsonp', url: "https://imp-portfolio-demonstration.herokuapp.com/json/persons.jsonp", async: false, contentType: "application/json; charset=utf-8"});
